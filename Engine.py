...
def evaluateBoard(self):
    ...
    for square in self.boardPieces.values():
        if not square.piece == "King":
            ...
            if (square.xLocation == 4 and square.yLocation == 4) or \
               (square.xLocation == 4 and square.yLocation == 5) or \
               (square.xLocation == 5 and square.yLocation == 4) or \
               (square.xLocation == 5 and square.yLocation == 5):
                if square.colour == "Black":
                    sum += 150
                elif square.colour == "White":
                    sum -= 150
