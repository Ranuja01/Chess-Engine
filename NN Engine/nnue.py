...
onnx_model, _ = tf2onnx.convert.from_function(
    ...
    opset=13,
    output_path="NNUE_flat_with_phase_21_to_61.onnx"
)

if platform.system() == 'Windows':
    data_path = r'NNUE.keras'
elif platform.system() == 'Linux':
    data_path = '/mnt/c/Users/Kumodth/Desktop/Programming/Chess Engine/Chess-Engine/NN Engine/NNUE_flat_with_phase_21_to_61.keras'  # Example for WSL
